...
```{r}
testing_data %>% 
  filter(grepl("High School", school_name), subject == "Algebra I", grade == "All Grades", subgroup == "All Students") %>% 
  select(pct_below_bsc, pct_bsc, pct_prof, pct_adv) %>% 
  stack() %>% 
...
testing_data %>% 
  ...
  plot_ly(y = ~pct_below_bsc, type = "box", text = ~school_name, name = "pct_below_bsc") %>% 
  add_trace(y = ~pct_bsc, name = "pct_bsc") %>% 
  add_trace(y = ~pct_prof, name = "pct_prof") %>% 
  add_trace(y = ~pct_adv, name = "pct_adv") 
...
testing_data %>% 
  filter(grepl("High School", school_name), subject == "Algebra I", grade == "All Grades", subgroup == "All Students") %>% 
  select(school_name, pct_below_bsc, pct_bsc, pct_prof, pct_adv) %>% 
  plot_ly(y = ~school_name, x = ~pct_below_bsc, type = "bar", name = "pct_below_bsc") %>% 
  add_trace(x = ~pct_bsc, name = "pct_bsc") %>% 
  add_trace(x = ~pct_prof, name = "pct_prof") %>% 
  add_trace(x = ~pct_adv, name = "pct_adv") %>% 
